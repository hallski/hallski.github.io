import{S as k,i as w,s as x,w as h,f as M,m as S,j as T,k as v,q as $,n as D,o as H,P as y,e as c,g as m,a as L,b as n,d as l}from"./vendor-e167c7c5.js";import{B as q}from"./blog-layout-233a6880.js";function I(r){let t,i,u,d,s,a,p,g,f,b,_;return{c(){t=c("p"),t.innerHTML="I often find myself add a bunch of <tt>#ifdef</tt>s for code that I only want executed during the development but not in the shipped products. In order to make the code a bit easier to read I decided to make a small method that takes a C block (available in iOS 4.0 and Mac OS X 10.6) instead.",i=m(),u=c("p"),u.textContent="You would use it like this:",d=m(),s=c("div"),s.innerHTML=`<div class="highlight"><pre class="highlight"><code><span class="hljs-comment">/*
