import{S as x,i as k,s as w,y as b,r as M,u as S,v as T,w as v,m as $,k as D,x as H,I as y,e as c,g as m,a as I,c as n,n as L,f as l}from"./index-a9b4120b.js";import{B as O}from"./blog-layout-6dd02b2d.js";function Y(d){let t,i,u,p,s,a,r,g,f,h,_;return{c(){t=c("p"),t.innerHTML="I often find myself add a bunch of <tt>#ifdef</tt>s for code that I only want executed during the development but not in the shipped products. In order to make the code a bit easier to read I decided to make a small method that takes a C block (available in iOS 4.0 and Mac OS X 10.6) instead.",i=m(),u=c("p"),u.textContent="You would use it like this:",p=m(),s=c("div"),s.innerHTML=`<div class="highlight"><pre class="highlight"><code><span class="hljs-comment">/*
