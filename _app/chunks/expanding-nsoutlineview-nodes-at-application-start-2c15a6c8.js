...
}</code></pre></div>`,S(s,"class","highlighter-rouge language-objc")},m(t,o){i(t,e,o),i(t,a,o),i(t,n,o),i(t,l,o),i(t,s,o)},d(t){t&&c(e),t&&c(a),t&&c(n),t&&c(l),t&&c(s)}}}function O(r){let e,a;const n=[r[0],u];let l={$$slots:{default:[C]},$$scope:{ctx:r}};for(let s=0;s<n.length;s+=1)l=p(l,n[s]);return e=new N({props:l}),{c(){b(e.$$.fragment)},m(s,t){y(e,s,t),a=!0},p(s,[t]){const o=t&1?v(n,[t&1&&h(s[0]),t&0&&h(u)]):{};t&2&&(o.$$scope={dirty:t,ctx:s}),e.$set(o)},i(s){a||(w(e.$$.fragment,s),a=!0)},o(s){x(e.$$.fragment,s),a=!1},d(s){k(e,s)}}}const u={comments:!1,date:"2009-04-06T00:00:00Z",section:"blog",tags:["objective-c"],title:"Expanding NSOutlineView nodes at application start"};function T(r,e,a){return r.$$set=n=>{a(0,e=p(p({},e),m(n)))},e=m(e),[e]}class $ extends f{constructor(e){super();j(this,e,T,O,g,{})}}var P=Object.freeze({__proto__:null,[Symbol.toStringTag]:"Module",default:$,metadata:u});export{$ as E,P as _,u as m};
